(module
  ...
  (type $54 (func (param i32 i32 i32 i32 i32 i32) (result i32)))
  (type $55 (func (param i32 i32 i32 i32 i32) (result i32)))
  (type $56 (func (param i32 i32 i32 i32 i32) (result i32)))
  (type $57 (func (param i32 i32 i32 i32 i32 i32 i32) (result i32)))
  (type $58 (func (param i32 i32 i32 i32 i32) (result i32)))
  (type $59 (func (param i32 i32 i32 i32 i32 i32) (result i32)))
  (type $60 (func (param i32 i32 i32 i32 i32) (result i32)))
  (type $61 (func (param i32 i32 i32 i32 i32 i32) (result i32)))
  ...
  (type $76 (func (param i32 i32 i32 i32 i32) (result i32)))
  (type $77 (func (param i32 i32 i32 i32 i32 i32 i32 i32 i32) (result i32)))
  (type $78 (func (param i32 i32 i32 i32 i32 i32 i32) (result i32)))
  (type $79 (func (param i32 i32 i32) (result i32)))
  (type $80 (func (param i32 i32 i32) (result i32)))
  (type $81 (func (param i32 i32 i32 i32 i32 i32 i32 i32 i32 i32) (result i32)))
  (type $82
  ...
  (import "Hacl_Curve25519_51" "Hacl_Curve25519_51_ecdh" (func $32 (type 32)))
  (import "Hacl_Ed25519" "Hacl_Bignum25519_fmul" (func $33 (type 33)))
  (import "Hacl_Ed25519" "Hacl_Bignum25519_inverse" (func $34 (type 34)))
  (import
    "Hacl_Ed25519"
  ...
  (import "Hacl_Ed25519" "Hacl_Impl_BignumQ_Mul_mul_modq" (func $38 (type 38)))
  (import "Hacl_Ed25519" "Hacl_Impl_BignumQ_Mul_add_modq" (func $39 (type 39)))
  (import
    "Hacl_Ed25519"
  ...
  (import "Hacl_Ed25519" "Hacl_Ed25519_sign" (func $45 (type 45)))
  (import "Hacl_Ed25519" "Hacl_Ed25519_verify" (func $46 (type 46)))
  (import "Hacl_Ed25519" "Hacl_Ed25519_secret_to_public" (func $47 (type 47)))
  (import "Hacl_Ed25519" "Hacl_Ed25519_expand_keys" (func $48 (type 48)))
  (import "Hacl_Ed25519" "Hacl_Ed25519_sign_expanded" (func $49 (type 49)))
  (import "Impl_Signal_Crypto" "random_bytes" (func $50 (type 50)))
  (import "Impl_Signal_Crypto" "secure_compare" (func $51 (type 51)))
  (import "Impl_Signal_Crypto" "priv_to_pub" (func $52 (type 52)))
  (import "Impl_Signal_Crypto" "dh" (func $53 (type 53)))
  (import "Impl_Signal_Crypto" "hkdf1" (func $54 (type 54)))
  (import "Impl_Signal_Crypto" "hkdf2" (func $55 (type 55)))
  (import "Impl_Signal_Crypto" "hkdf3" (func $56 (type 56)))
  (import "Impl_Signal_Crypto" "hkdf_standalone" (func $57 (type 57)))
  (import "Impl_Signal_Crypto" "enc" (func $58 (type 58)))
  (import "Impl_Signal_Crypto" "enc_standalone" (func $59 (type 59)))
  (import "Impl_Signal_Crypto" "dec" (func $60 (type 60)))
  (import "Impl_Signal_Crypto" "dec_standalone" (func $61 (type 61)))
  (import "Impl_Signal_Crypto" "hmac" (func $62 (type 62)))
  (import "Impl_Signal_Crypto" "hmac_standalone" (func $63 (type 63)))
  (import "Impl_Signal_Crypto" "hmac_mut" (func $64 (type 64)))
  (import "Impl_Signal_Crypto" "curve25519_sign_modified_" (func $65 (type 65)))
  (import "Impl_Signal_Crypto" "curve25519_sign_modified" (func $66 (type 66)))
  (import "Impl_Signal_Crypto" "sign" (func $67 (type 67)))
  (import "Impl_Signal_Crypto" "curve25519_verify" (func $68 (type 68)))
  (import "Impl_Signal_Crypto" "verify" (func $69 (type 69)))
  (import "Impl_Signal_Crypto" "cipherlen" (func $70 (type 70)))
  (import "Impl_Signal_Crypto" "ecdhe" (func $71 (type 71)))
  (import "Impl_Signal_Crypto" "hash_sha512" (func $72 (type 72)))
  ...
  (func $80
    ...
    (if
      ...
      (else
        ...
        (if
          (result i32)
          (then (i32.const 2) (set_local 13) (i32.const 0))
          (else
            (i32.const 33)
            (get_local 10)
            (i32.lt_u)
            (if
              (result i32)
              (then (i32.const 3) (set_local 14) (i32.const 0))
              (else
                (i32.const 33)
                (get_local 11)
                (i32.lt_u)
                (if
                  (result i32)
                  (then (i32.const 4) (set_local 15) (i32.const 0))
                  (else (i32.const 5) (set_local 15) (i32.const 0))
                )
                (drop)
                (get_local 15)
                (set_local 14)
    ...
    (if
      (result i32)
      (then (i32.const 1) (set_local 20) (i32.const 0))
      (else
        (get_local 1)
        (get_local 17)
        (i32.lt_u)
        (if
          (result i32)
          (then (i32.const 2) (set_local 21) (i32.const 0))
          (else
            (get_local 1)
            (get_local 18)
            (i32.lt_u)
            (if
              ...
              (else
                ...
                (if
                  (result i32)
                  (then (i32.const 4) (set_local 23) (i32.const 0))
                  (else (i32.const 5) (set_local 23) (i32.const 0))
                )
                (drop)
                (get_local 23)
                (set_local 22)
    ...
    (if
      (result i32)
      (then (i32.const 1) (set_local 28) (i32.const 0))
      (else
        (get_local 0)
        (get_local 25)
        (i32.lt_u)
        (if
          (result i32)
          (then (i32.const 2) (set_local 29) (i32.const 0))
          (else
            (get_local 0)
            (get_local 26)
            (i32.lt_u)
            (if
              (result i32)
              (then (i32.const 3) (set_local 30) (i32.const 0))
              (else
                (get_local 0)
                (get_local 27)
                (i32.lt_u)
                (if
                  (result i32)
                  (then (i32.const 4) (set_local 31) (i32.const 0))
                  (else (i32.const 5) (set_local 31) (i32.const 0))
                )
                (drop)
                (get_local 31)
                (set_local 30)
    ...
    (if
      (result i32)
      (then (i32.const 1) (set_local 36) (i32.const 0))
      (else
        (get_local 7)
        (get_local 33)
        (i32.lt_u)
        (if
          (result i32)
          (then (i32.const 2) (set_local 37) (i32.const 0))
          (else
            (get_local 7)
            (get_local 34)
            (i32.lt_u)
            (if
              (result i32)
              (then (i32.const 3) (set_local 38) (i32.const 0))
              (else
                (get_local 7)
                (get_local 35)
                (i32.lt_u)
                (if
                  (result i32)
                  (then (i32.const 4) (set_local 39) (i32.const 0))
                  (else (i32.const 5) (set_local 39) (i32.const 0))
                )
                (drop)
                (get_local 39)
                (set_local 38)
  ...
  (func $82
    ...
    (if
      (result i32)
      (then (i32.const 0) (set_local 189) (i32.const 0))
      (else
        (get_local 1)
        (set_local 190)
        (get_local 8)
  ...
  (export "verify_sig" (func 74))
  (export "sign0" (func 75))
  (export "ratchet" (func 76))
  (export "initiate" (func 77))
  (export "respond" (func 78))
  (export "fill_message_keys" (func 79))
  (export "encrypt_get_length" (func 80))
  (export "encrypt" (func 81))
  (export "decrypt" (func 82))
  (export "priv_to_pub0" (func 83))
  (export "generate_key_pair" (func 84))
