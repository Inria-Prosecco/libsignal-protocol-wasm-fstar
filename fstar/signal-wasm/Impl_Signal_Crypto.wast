(module
  ...
  (func $68
    ...
    (if
      ...
      (then
        ...
        (if
          ...
          (then
            ...
            (if
              (result i32)
              (then (i32.const 1) (set_local 121) (i32.const 0))
              (else
                (get_local 120)
                (i64.const 268435456)
                (i64.lt_u)
                (if
                  (result i32)
                  (then (i32.const 0) (set_local 122) (i32.const 0))
                  (else
                    (get_local 119)
                    (i64.const 0)
                    (i64.gt_u)
                    (if
                      (result i32)
                      (then (i32.const 1) (set_local 123) (i32.const 0))
                      (else
                        (get_local 118)
                        (i64.const 5342)
                        (i64.gt_u)
                        (if
                          (result i32)
                          (then (i32.const 1) (set_local 124) (i32.const 0))
                          (else
                            (get_local 118)
                            (i64.const 5342)
                            (i64.lt_u)
                            (if
                              (result i32)
                              (then (i32.const 0) (set_local 125) (i32.const 0))
                              (else
                                (get_local 117)
            ...
            (if
              (result i32)
              (then (i32.const 0) (set_local 129) (i32.const 0))
              (else
                (i32.const 5)
                (set_local 130)
                (get_local 130)
          ...
          (else (i32.const 0) (set_local 95) (i32.const 0))
        )
        (drop)
        (get_local 95)
        (set_local 92)
      ...
      (else (i32.const 0) (set_local 92) (i32.const 0))
    )
    (drop)
    (get_local 92)
    (set_local 151)
  ...
  (func $73 (type 73) (get_global 0) (i32.const 975) (i32.add) (set_global 3))
  (export "secure_compare" (func 51))
  (export "priv_to_pub" (func 52))
  (export "dh" (func 53))
  (export "hkdf1" (func 54))
  (export "hkdf2" (func 55))
  (export "hkdf3" (func 56))
  (export "hkdf_standalone" (func 57))
  (export "enc" (func 58))
  (export "enc_standalone" (func 59))
  (export "dec" (func 60))
  (export "dec_standalone" (func 61))
  (export "hmac" (func 62))
  (export "hmac_standalone" (func 63))
  (export "hmac_mut" (func 64))
  (export "curve25519_sign_modified_" (func 65))
  (export "curve25519_sign_modified" (func 66))
  (export "sign" (func 67))
  (export "curve25519_verify" (func 68))
  (export "verify" (func 69))
  (export "cipherlen" (func 70))
  (export "ecdhe" (func 71))
  (export "hash_sha512" (func 72))
